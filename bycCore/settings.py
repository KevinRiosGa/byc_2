...
SECRET_KEY = 'django-insecure-on(_y!qsi4gk+8+&&4%s0=b4%9zu+1vw28np1yl%qf1bd+y=x#'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'bycCore',  # Cambia esto por el nombre de tu base de datos
        'USER': 'postgres',                 # Usuario de PostgreSQL
        'PASSWORD': '123456',          # Contraseña del usuario
        'HOST': 'localhost',                  # Dirección del host (localhost si es local)
